      ...
      <aside class="control-sidebar control-sidebar-dark">
          <div class="pad">
              <h4 class="control-sidebar-heading">后台配置</h4>
              <div class="form-group">
                  <label class="control-sidebar-subheading">
                      <input type="checkbox" data-layout="fixed" class="pull-right" id="ajax-toggle">Ajax 新建/编辑表单</label>
                  <p>弹出Modal框 新建/编辑表单</p>
              </div>
              <h4 class="control-sidebar-heading">后台皮肤</h4>
